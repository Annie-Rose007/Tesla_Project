...
Le graphique ci-dessous ventile le nombre de décès par catégorie de victimes, permettant de confirmer si le conducteur survit effectivement plus souvent que ses passagers ou les tiers lors de ces collisions :
