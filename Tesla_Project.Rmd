...
•	Cela signifie que le modèle explique environ 15,6 % de la variation du nombre de décès. C'est un score relativement faible (proche de 0), ce qui indique que beaucoup d'autres facteurs non inclus dans le code (vitesse, météo, type de route) influencent grandement la mortalité. 
