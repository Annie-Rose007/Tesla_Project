...
Pour vérifier cette théorie, nous avons isolé les variables identifiant le rôle de chaque victime : le conducteur, les passagers du véhicule Tesla, les occupants des autres véhicules impliqués, ainsi que les usagers vulnérables (piétons et cyclistes). Cette distinction est cruciale pour comprendre si l'assistance à la conduite modifie la nature des risques pour les différentes personnes présentes sur la route.

Le graphique précédant,  intitulé "Décès liés à l’Autopilote par catégorie de victime et modèle de voiture", ventile les données par profil de victime. Cette visualisation permet de vérifier si, lors de ces collisions, le conducteur présente effectivement un taux de survie supérieur à celui des passagers ou des tiers.
