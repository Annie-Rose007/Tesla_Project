...
Tesla_casualties <- td_csv %>%
  select(Year, Date, Country, State, Deaths, Description, `Tesla driver`, `Tesla occupant`, `Other vehicle`, `Cyclists/ Peds`, `TSLA+cycl / peds`, Model, `AutoPilot claimed`, `Verified Tesla Autopilot Death`) %>%
...
#Remplacer les "-"
  mutate(State = na_if(State, "-"),
         ...
         `TSLA+cycl / peds` = na_if(`TSLA+cycl / peds`, "-"),
         Model = na_if(Model, "-"),
         `AutoPilot claimed` = na_if(`AutoPilot claimed`, "-"),
         `Verified Tesla Autopilot Death` = na_if(`Verified Tesla Autopilot Death`, "-")) %>%

#Convertir les colonnes en types numerique
  mutate(across(
    c(`Tesla driver`, `Tesla occupant`, `Other vehicle`, `Cyclists/ Peds`, `TSLA+cycl / peds`, `AutoPilot claimed`, `Verified Tesla Autopilot Death`), as.numeric)) %>%
  
#Remplacer toutes les valeurs NA, etc par "0"
  mutate(across(
    c(`Tesla driver`, `Tesla occupant`, `Other vehicle`, `Cyclists/ Peds`, `TSLA+cycl / peds`, `AutoPilot claimed`, `Verified Tesla Autopilot Death`), replace_na, 0))
